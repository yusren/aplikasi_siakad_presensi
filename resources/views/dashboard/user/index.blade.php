    ...
    <div class="card-header">
        <div class="row">
            ...
            <div class="col align-self-center ps-0">
                <h4 class="text-color-theme"><span class="fw-normal">Hi</span>, {{ auth()->user()->name }} - ( {{
                    auth()->user()->nomor }} )</h4>
                <p class="text-muted">
        ...
        <a href="#" class="mb-3 card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col align-self-center ps-0">
                        <p class="mb-1 text-color-theme">@judul($item->judul)</p>
                        <p class="text-muted size-12">@desc($item->description)</p>
                    </div>
                </div>
            </div>
        </a>
